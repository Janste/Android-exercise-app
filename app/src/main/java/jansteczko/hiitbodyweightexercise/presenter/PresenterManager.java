...
public class PresenterManager {
    ...
    PresenterManager(long maxSize, long expirationValue, TimeUnit expirationUnit) {
        ...
        presenters = CacheBuilder.newBuilder()
                .maximumSize(maxSize) // maximum number of entries the cache may contain
                .expireAfterWrite(expirationValue, expirationUnit) // each entry should be removed after a fixed time
                .build();
    }
